...
process.argv.forEach(function (val, index, array) {
    if(val == "help"){
        console.log("")
        console.log("node atkryptcmd.js krypt level string")
        console.log("Levels = 1-9")
        console.log("node atkryptcmd.js dekrypt \'string\'")
        console.log("")
        return;
    }
    if(val === "krypt" || next =="krypt"){
        if(next == "krypt"){
            if(level >= 0){
                console.log("")
                console.log("Results:")
                console.log(atKrypt(val, level));
                console.log("")
            }
        }
        level = val;
...
function atKrypt(cryptString, subCount){
    ...
    var enkryptattava = String(cryptString);
...
function atDekrypt(decryptString){
    var hkmpv = 2^53;
    decryptFinalText = "";
    var dekryptattava = String(decryptString);
    var currentChars = "";
